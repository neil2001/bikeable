...
function heatmapWidthExpression(): maplibregl.ExpressionSpecification {
  ...
  return [
    ...
    ["zoom"],
    8,
    byScore(0.08, 0.18, 0.33, 0.53),
    10,
    byScore(0.15, 0.30, 0.53, 0.83),
    12,
    byScore(0.30, 0.53, 0.90, 1.35),
    14,
    byScore(0.60, 1.05, 1.73, 2.40),
    16,
    byScore(1.28, 2.10, 3.15, 4.20),
    18,
    byScore(2.10, 3.45, 5.10, 6.60),
  ];
}
